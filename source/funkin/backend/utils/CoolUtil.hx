...
import funkin.menus.NewStoryMenuState.MapStruct;
...
class CoolUtil
{
	public static function mapTheMapLol(metaData:MapStruct, colsGroup:Array<BoardTile>):Map<BoardTile, Array<BoardTile>>
        {
			var moveMap = new Map<BoardTile, Array<BoardTile>>();
	...
	public static function parseMapData(curMap:String = "MARS"):MapStruct{
        var path = Paths.json('mapData/${curMap.toUpperCase()}-DATA');
